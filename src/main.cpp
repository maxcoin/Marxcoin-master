...
static const int64 nTargetSpacing = 50; // 50 seconds changedxx
static const int64 nInterval = nTargetTimespan / nTargetSpacing;

static const int nUpdatePoint = 3467; //23 Jan 2014 Update
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
		...
		nshare = nGenesisBlockCoin* 999/a;	// Initial share of Marxcoin
    	if ((nshare < nBlockRewardMinimumCoin)||(nHeight>=nUpdatePoint))//23 Jan 2014 Update
    	{
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    if((pindexLast->nHeight+1)<nUpdatePoint)//before 23 Jan 2014
    {
	...
	else if((pindexLast->nHeight+1)==nUpdatePoint)//23 Jan 2014 Update
	{
