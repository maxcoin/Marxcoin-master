...
void MiningPage::minerError(QProcess::ProcessError error)
{
    ...
    {
        reportToList("Miner failed to start. Make sure you have the minerd executable and libraries in the same directory as digitalcoin-Qt.", ERROR, NULL);
    }
}
...
void MiningPage::minerFinished()
{
	...
	//printf("MiningPage::minerFinished setMining \n");
...
void MiningPage::minerStarted()
{
	...
	//printf("MiningPage::minerStarted setMining \n");
...
void MiningPage::updateSpeed()
{
	...
	//printf("MiningPage::updateSpeed setMining \n");
