...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click marxcoin: links)
...
{
    // clicking on marxcoin: URLs creates FileOpen events on the Mac:
